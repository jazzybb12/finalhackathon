            ...
            <div className='lg:flex lg:flex-1 py-16'>
                <div className="flex flex-1 justify-center lg:justify-around ms-8 lg:ms-0 mb-6 flex-wrap">
                    <div className='flex flex-col items-center'>
                        ...
                        <p>Powered By <a className='font-bold hover:text-blue-300 text-lg' href="www.google.com" target='__blank'>Saad Abdullah</a> </p>
                    </div>
                    <div className='hidden lg:block'>
                        <h1 className='text-xl font-bold'>Informational Stuff</h1>
